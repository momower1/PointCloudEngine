...
void PointCloudEngine::GUI::CreateRendererElements()
{
	...
	pullPushElements.push_back(new GUISlider<float>(hwndGUI, GS(160), GS(310), GS(130), GS(20), 0, 1000, 10, 0, L"Importance Exponent", &settings->pullPushImportanceExponent, 1, GS(148), GS(40)));
