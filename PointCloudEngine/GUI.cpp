...
void PointCloudEngine::GUI::CreateRendererElements()
{
	...
	pullPushElements.push_back(new GUISlider<int>(hwndGUI, GS(160), GS(310), GS(130), GS(20), 0, 12, 1, 0, L"Pull Push Level", &settings->pullPushDebugLevel, 2, GS(148), GS(40)));
	pullPushElements.push_back(new GUISlider<float>(hwndGUI, GS(160), GS(340), GS(130), GS(20), 0, 1000, 1000, 0, L"Splat Size", &settings->pullPushSplatSize, 2, GS(148), GS(40)));
