...
void PointCloudEngine::GUI::CreateRendererElements()
{
	...
	pullPushElements.push_back(new GUISlider<float>(hwndGUI, GS(160), GS(280), GS(130), GS(20), 0, 1000, 1000, 0, L"Depth Bias", &settings->pullPushDepthBias, 2, GS(148), GS(40)));
